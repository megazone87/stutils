...
# SYNOPSIS
#
#   AX_PROG_SPLINT_RECURSIVE([AX_SPLINTFLAGS])
#
# DESCRIPTION
#
...
#
#   Add following line in top-level Makefile.am
#
#     AM_EXTRA_RECURSIVE_TARGETS([splint-check])
#
...
AC_DEFUN([AX_PROG_SPLINT_RECURSIVE],
[
...
splint-check-local: all \$(SPLINTFILES)
